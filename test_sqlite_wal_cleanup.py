...
def test_wal_cleanup_with_context_manager_pattern(temp_dir):
    ...
    assert not wal_path.exists(), "WAL file should be removed after context manager cleanup"
    assert not shm_path.exists(), "SHM file should be removed after context manager cleanup"
