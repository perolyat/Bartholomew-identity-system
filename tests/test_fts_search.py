...
async def test_fts_basic_search():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        await store.upsert_memory(
            "fact",
            "ai_ethics",
            "Artificial intelligence systems should prioritize user privacy and data protection",
        ...
        await store.upsert_memory(
            "preference",
            "communication_style",
            "User prefers direct communication without excessive formality or jargon",
...
async def test_fts_snippet():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Generate snippet
        fts = FTSClient(db_path)
        snippet = fts.snippet(result.memory_id, column="value", start_mark="**", end_mark="**")
...
async def test_fts_rebuild_index():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        await store.upsert_memory("fact", "key3", "Content three", "2025-01-01T12:02:00Z")
