...
class TestWeightAdjustment:
    ...
    def test_lexical_increases_fts_weight(self):
        ...
        # Lexical query
        adj_fts, adj_vec = _query_aware_weights('"privacy policy"', base_fts, base_vec)
    ...
    def test_neutral_keeps_base_weights(self):
        ...
        # Neutral query
        adj_fts, adj_vec = _query_aware_weights("machine learning", base_fts, base_vec)
    ...
    def test_weight_clamping(self):
        ...
        adj_fts, adj_vec = _query_aware_weights("kind:event AND status:active", base_fts, base_vec)
...
class TestHybridRetrieverIntegration:
    ...
    def test_weight_override_takes_precedence(self):
        ...
        config = HybridRetrievalConfig(fusion_mode="weighted", weight_fts=0.6, weight_vec=0.4)
        ...
        fused = retriever._fuse_weighted(fts_scores, vec_scores, weight_fts=0.8, weight_vec=0.2)
    ...
    def test_rrf_ignores_query_weighting(self):
        ...
        # Prepare test data
        fts_results = [{"id": 1, "rank": 0.5}, {"id": 2, "rank": 2.0}]
    ...
    def test_query_aware_disabled(self):
        ...
        fused = retriever._fuse_weighted(
            ...
            vec_scores,
            weight_fts=None,
            weight_vec=None,  # Will use config
        )
...
class TestEdgeCases:
    ...
    def test_weight_normalization_after_clamping(self):
        ...
        adj_fts, adj_vec = _query_aware_weights('"exact phrase"', base_fts, base_vec)
