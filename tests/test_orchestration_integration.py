...
def test_formatter_structured_mode():
    ...
    result = formatter.format("Hello", tone="authoritative", emotion="enthusiastic")
...
def test_formatter_invalid_values():
    ...
    result = formatter.format("Hello", tone="invalid_tone", emotion="invalid_emotion")
...
def test_logging_tracks_steps(orchestrator):
    ...
    assert "inject_memory_context" in steps or any("inject" in s for s in steps)
