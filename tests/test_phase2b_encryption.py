...
class TestEnvKeyProvider:
    ...
    def test_fallback_ephemeral_keys_with_warning(self, monkeypatch, caplog):
...
class TestEncryptionEngine:
    ...
    def test_decide_strength_standard(self):
        ...
        assert EncryptionEngine._decide_strength({"encrypt": "standard"}) == "standard"

    def test_decide_strength_strong(self):
        """Resolve 'strong' strength"""
        assert EncryptionEngine._decide_strength({"encrypt": "strong"}) == "strong"

    def test_decide_strength_true_means_standard(self):
        """Boolean true resolves to 'standard'"""
        assert EncryptionEngine._decide_strength({"encrypt": True}) == "standard"

    def test_decide_strength_false_means_none(self):
        """Boolean false means no encryption"""
        assert EncryptionEngine._decide_strength({"encrypt": False}) is None
...
class TestMemoryStoreIntegration:
    ...
    @pytest.mark.asyncio
    async def test_memory_encrypts_by_rule_standard(self, tmp_path, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_memory_encrypts_by_rule_strong(self, tmp_path, monkeypatch):
