...
class TestRedactionEngine:
    ...
    def test_apply_redaction_replace(self):
        ...
        rule = {
            "content": r"email@example\.com",
            "redact_strategy": "replace:[EMAIL REDACTED]"
        }
    ...
    def test_apply_redaction_unknown_strategy(self):
        ...
        rule = {
            "content": r"test",
            "redact_strategy": "unknown_strategy"
        }
...
class TestRedactionYAMLRules:
            ...
            if "redact" in config:
                for rule in config["redact"]:
                    ...
                    if "redact_strategy" in metadata:
                        ...
                        assert strategy in [
                            "mask", "remove"
                        ] or strategy.startswith("replace:")
    ...
    def test_yaml_rules_have_phase2a_fields(self):
        ...
        if os.path.exists(yaml_path):
            ...
            assert phase2a_fields_found, \
                "No Phase 2a fields found in memory_rules.yaml"
