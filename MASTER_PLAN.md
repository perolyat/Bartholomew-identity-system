...
3. **Build a minimal Stage 1 consumer web governance shell**, after separate approval of both
   ...
   with **S1.1 (Parking Brake API + UI) and S1.5 (governance audit/provenance view) implemented**
   — S1.2–S1.4 and S1.6 remain scoped-only, each requiring its own separate approval.
